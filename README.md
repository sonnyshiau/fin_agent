...
![fin_agent：從技術架構連結供應鏈、基本面與估值的 AI 基礎設施研究](docs/assets/fin-agent-readme-hero.svg)
...
- **[AI Scale-up × Astera Labs Signal Plane](https://sonnyshiau.github.io/fin_agent/ai-scale-up-astera-labs-path/)** — 分離 Host、CXL Memory、CPU–GPU Coherent 與 GPU Scale-up 路徑，定位 Aries、Leo、Scorpio P／X 的架構層。
...
- [AI Scale-up × Astera Labs Signal Plane](https://sonnyshiau.github.io/fin_agent/ai-scale-up-astera-labs-path/) — 動態比較 PCIe／CXL Host Path、CPU–GPU Coherent 與 GPU-to-GPU Scale-up，拆解 Astera Labs 連接產品的正確位置。
